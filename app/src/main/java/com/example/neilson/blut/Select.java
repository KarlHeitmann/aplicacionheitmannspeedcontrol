...
public class Select extends Activity implements PullToRefresh.OnRefreshListener {
    ...
    private Button bot15;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select);  // de .select a activity_select
        ...
        bot15 = (Button) findViewById(R.id.bot15);
        bot15.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        ...
                        Toast.makeText(Select.this, "Activa Bluetooth", Toast.LENGTH_LONG).show(); //turn on bluetooth
                        break;
